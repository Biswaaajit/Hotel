...
<div id="doubleInfo">
    <div class="row">
        <div class="col-md-4 col-md-offset-1">
            <div class="IndexFont">
                <h1>Prestige Room</h1>
                <p id="doublePara">250m<sup>2</sup> / Village View / 6 Guest</p>
                <div id="doubleIcons">
                    <i class="fa-solid fa-users fa-lg doubleIcon"></i><span>6 Guest</span>
                    <i class="fa-solid fa-bed fa-lg doubleIcon"></i><span>3 Bed</span>
                    <i class="fa-solid fa-bath fa-lg doubleIcon"></i><span>3 Bathroom</span>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-xs-offset-2"> <!--    top Portion       -->
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <p id="doubleStyle3"><span id="doubleStyle">From </span><span style="font-weight: 700">&#36;9000</span>/night</p>
                                </div>
                            </div>
                        </div>
